  ...
  const options: Options = {
    ...
    renderNode: {
      ...
      [BLOCKS.OL_LIST]: (node, children) => (
        <ol className="mt-2 list-decimal pl-10">{children}</ol>
      ),
      [BLOCKS.LIST_ITEM]: (node, children) => {
        // Text in li tags is wrapped in p tags by default. This is a workaround to remove p tags. https://github.com/contentful/rich-text/issues/126#issuecomment-981068613
